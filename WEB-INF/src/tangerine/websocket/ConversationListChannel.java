...
@ServerEndpoint(value = "/channel/conversation/list", configurator = WebSocketConfigurator.Configurator.class)
public class ConversationListChannel extends Channel {
